...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Full and half day buttons
  const fullDayButton = document.getElementById("full");
  const halfDayButton = document.getElementById("half");

  // Calculated cost element
  const calculatedCostElement = document.getElementById("calculated-cost");

  // Clear button
  const clearButton = document.getElementById("clear-button");

  // Function to update calculated cost
  function updateCalculatedCost() {
    calculatedCostElement.textContent = dailyRate * dayCounter;
  }
  ...
  // Event listeners for full and half day buttons
